...
def get_transform_my_mat (image_landmarks, face_type, scale=1.0):
    ...
    #ljy
    real_size = npla.norm(l_t[1] - l_t[0])
    #print(f'padding={padding}, g_p[0]={g_p[0]}, g_p[1]={g_p[1]}, mod={mod}, real_size={real_size}')
    pts2 = np.float32(( (0,0),(real_size,0),(real_size,real_size) ))
    mat = cv2.getAffineTransform(l_t,pts2)
    return mat, int(real_size)
